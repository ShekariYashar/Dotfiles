...
'-h[Print help]' \
'--help[Print help]' \
'::name -- The name of preset to be printed:(bracketed-segments plain-text-symbols pure-preset no-nerd-font tokyo-night nerd-font-symbols pastel-powerline no-runtime-versions no-empty-icons)' \
&& ret=0
;;
(print-config)
_arguments "${_arguments_options[@]}" \
